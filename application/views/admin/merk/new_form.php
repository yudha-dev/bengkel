            ...
            <div class="container-fluid">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo site_url('admin/merk/add') ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('merk') ? 'is-invalid' : '' ?>" type="text" name="merk" placeholder="" />
                                <div class="invalid-feedback">
