            ...
            <div class="container-fluid">
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <a href="<?php echo site_url('admin/superadmin/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
                    </div>
                    <div class="card-body">

                        <form action="<?php echo site_url('admin/superadmin/add') ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="nama">Nama</label>
                                <input class="form-control <?php echo form_error('name') ? 'is-invalid' : '' ?>" type="text" name="nama" placeholder="" />
