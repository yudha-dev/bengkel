            ...
            <div class="container-fluid">
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <a href="<?php echo site_url('bengkel/keluhan/add') ?>"><i class="fas fa-plus"></i> Add New</a>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    <?php foreach ($keluhan as $keluhan) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $keluhan->harga ?>
                                            </td>

                                            <td>
                                                <a href="<?php echo site_url('bengkel/keluhan/edit/' . $keluhan->id_kel) ?>" class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
                                                <a onclick="deleteConfirm('<?php echo site_url('bengkel/keluhan/delete/' . $keluhan->id_kel) ?>')" href="#!" class="btn btn-small text-danger"><i class="fas fa-trash"></i> Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
